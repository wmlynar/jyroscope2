...
public class roslaunch
{
	...
	private static void printHelp()
	{
        ...
        help += "  --generate-uberjar=FILENAME\n";
	...
	private static void generateUberjar(final List<LaunchFile> launchFiles, String outputFile) throws FileNotFoundException, IOException
	{
		// Grab all rosparams
		Map<String, String> paramsMap =
				RosParamManager.getLoadRosParamsMap(launchFiles);
		...
		String output = UberjarGenerator.generateMainClass(paramsMap, classes);
	...
	public static void main(String[] args)
	{
		...
		{
			String outputFile = parsedArgs.getGenerateUberjar();
			try {
				generateUberjar(launchFiles, outputFile);
			}
			catch (Exception e)
			{
