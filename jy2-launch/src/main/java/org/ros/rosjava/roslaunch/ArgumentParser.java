...
public class ArgumentParser
{
	...
	private static final String GENERATE_UBERJAR_OPTION = "generate-uberjar";
	private static final String UBERJAR_OUTPUT_FOLDER_OPTION = "uberjar-output-folder";
	...
	public ArgumentParser(final String[] inputArgs)
	{
		...
		m_optionsWithValues.add(GENERATE_UBERJAR_OPTION);
		m_optionsWithValues.add(UBERJAR_OUTPUT_FOLDER_OPTION);
	...
	public boolean hasGenerateUberjar()
	{
		return hasOption(GENERATE_UBERJAR_OPTION);
	}
	
	public String getGenerateUberjar()
	{
		return getOption(GENERATE_UBERJAR_OPTION);
	}
	
	public boolean hasUberjarFolder()
	{
		return hasOption(UBERJAR_OUTPUT_FOLDER_OPTION);
	}
	
	public String getUberjarFolder()
	{
		return getOption(UBERJAR_OUTPUT_FOLDER_OPTION);
	}
