...
public class RosConvertPrimitive implements TypeConverterHelper<RosType, JavaType> {
    ...
    private static final List<String> javaPrimitives = Arrays.asList(new String[] {
        "boolean", 
        "byte", 
        "char", 
        "short", 
...
//        /*time*/      {null,      null,         null,              null,               null,          null,               null,               null,               null,        "#1"}     
        /*bool*/      {"(#1!=0)", "(byte)(#1)", null,              "(short)(#1&0xff)", "(#1&0xff)",    "(#1&0xff)",       "(#1&0xff)",        "(#1&0xff)",        null,        null},
        /*int8*/      {"(#1!=0)", "(byte)(#1)", null,              "(short)(#1)",      "#1",          "#1",               "#1",               "#1",               null,        null},
        /*int16*/     {"(#1!=0)", null,         null,              "(short)(#1)",      "#1",          "#1",               "#1",               "#1",               null,        null},
        /*int32*/     {"(#1!=0)", null,         null,              null,               "#1",          "#1",               "#1",               "#1",               null,        null},
        /*int64*/     {"(#1!=0)", null,         null,              null,               null,          "#1",               "#1",               "#1",               null,        null},
        /*uint8*/     {"(#1!=0)", "(byte)(#1)", "(char)(#1&0xff)", "(short)(#1&0xff)", "(#1&0xff)",   "(#1&0xff)",        "(#1&0xff)",        "(#1&0xff)",        null,        null},
        /*uint16*/    {"(#1!=0)", null,         "(char)(#1)",      "(short)(#1)",      "(#1&0xffff)", "(#1&0xffff)",      "(#1&0xffff)",      "(#1&0xffff)",      null,        null},
        /*uint32*/    {"(#1!=0)", null,         null,              null,               "#1",          "(#1&0xffffffffL)", "(#1&0xffffffffL)", "(#1&0xffffffffL)", null,        null},
        /*uint64*/    {"(#1!=0)", null,         null,              null,               null,          "#1",               "long #t = #1; #= (#t >= 0 ? (float)(#t&0x7fffffffffffffffL):(float)(#t&0x7fffffffffffffffL)+0x1.0p63f)", "long #t = #1; #= (#t >= 0 ? (float)(#t&0x7fffffffffffffffL):(float)(#t&0x7fffffffffffffffL)+0x1.0p63f)", null, null},
        /*float32*/   {null,      null,         null,              null,               null,          null,               "#1",               "#1",               null,        null},
        /*float64*/   {null,      null,         null,              null,               null,          null,               null,               "#1",               null,        null},
        /*duration*/  {null,      null,         null,              null,               null,          null,               null,               null,               "#1",        null},     
        /*time*/      {null,      null,         null,              null,               null,          null,               null,               null,               null,        "#1"}     
	...
	public String getReader(RosType from, JavaType to) {
		...
		int java = javaPrimitives.indexOf(to.getFullyQualifiedName());
	...
	public String getWriter(JavaType from, RosType to) {
        ...
        int ros = rosPrimitives.indexOf(primitive);
		int java = javaPrimitives.indexOf(from.getFullyQualifiedName());
        ...
        if(cast==null) {
			throw new RuntimeException("Cannot convert from " + from.getFullyQualifiedName() + " to " + to.getName());
        }
